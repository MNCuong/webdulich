...
<body>
	<?php
		...
		if ($file_error === UPLOAD_ERR_OK) {
			...
			$sql_insert_dulich="INSERT INTO `diadiemdulich` 
			(`id`, `ten`, `diachi`, `theloai`, `giatien`, `anh`, `dacdiem`, `gioithieu`) 
			VALUES('$id','$ten', '$diachi', '$theloai', '$giatien', '$file__name__', '$dacdiem', '$gioithieu')";
			mysqli_query($conn,$sql_insert_dulich);	
		}
			// Tìm CSDL đề làm việc
			// Câu truy vấn thêm dữ liệu được lưu vào biến $sql_insert_hangxs
			//echo $sql_insert_hangxs; die;
			// THực hiện truy vấn
			header('Location: Tablediadiem.php');
	?>
</body>
</html>