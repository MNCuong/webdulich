...
<body>
	<?php
		...
		if ($file_error === UPLOAD_ERR_OK) {
			...
			$sql_update_dulich="UPDATE `diadiemdulich` 
					SET `ten` = '$ten', `diachi` = '$diachi', `theloai` = '$theloai', `giatien` = '$giatien', `anh` = '$file__name__', `dacdiem` = '$dacdiem', `gioithieu` = '$gioithieu'
					WHERE `id` = '$id'";
			mysqli_query($conn,$sql_update_dulich);	
		}
