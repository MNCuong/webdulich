    ...
    <div class="cdContainer" style="flex-direction: column;">
        ...
        ?>
            <div class="cdContainer cdBorder cdPadding cdMargin" style="flex-direction: column;">
                <form action="xacNhanMuaVe.php?id=<?php echo $id[$i] ?>" method="post">
                    <div class="cdRow">
                    ...
                    <div class="cdRow">
                        ...
                        <div class="cdInputGroup ">
                            ...
                            <input type="number" class="cdInputInput" name="giaVe" value="<?php echo $qsoHanhKhach * $giaVe[$i] ?>" disabled>
                        </div>
                    </div>

                    <div class="cdRow cdCenter">
                        <button type="submit" class="cdButton cdMargin">Mua vé</button>
                    </div>
                </form>
            </div>
        <?php } ?>
