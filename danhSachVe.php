...
<body>
    ...
    <div class="cdContainer" style="flex-direction: column;">
        ...
        WHERE soHanhKhach >= $qsoHanhKhach AND phuongTien = $qphuongTien AND diemKhoiHanh LIKE '%$qdiemKhoiHanh%' LIMIT $offset, $sobg";
        ...
        <div class="cdContainer cdBorder cdPadding cdMargin" style="flex-direction: column;">
            <div class="cdRow">
                <div class="cdInputGroup">
                    ...
                    <input type="text" class="cdInputInput" name="phuongTien" value="<?php echo $phuongTien ?>"
                        disabled>
                </div>
                <div class="cdInputGroup">
                    <span class="cdInputText">Điểm khởi hành</span>
                    <input type="text" class="cdInputInput" name="diemKhoiHanh" value="<?php echo $diemKhoiHanh[$i] ?>"
                        disabled>
                </div>
                <div class="cdInputGroup">
            ...
            <div class="cdRow">
                ...
                <div class="cdInputGroup">
                    ...
                    <input type="number" class="cdInputInput" name="soHanhKhach" value="<?php echo $qsoHanhKhach ?>"
                        disabled>
                </div>
                <div class="cdInputGroup ">
                    <span class="cdInputText">Giá vé</span>
                    <input type="number" class="cdInputInput" name="giaVe"
                        value="<?php echo ($qsoHanhKhach * $giaVe[$i] / $soHanhKhach[$i]) ?>" disabled>
                </div>
            </div>
