...
<body>
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="adminDanhSachChuyenDi.php?phuongtien=1">Máy bay</a></li>
            <li><a class="dropdown-item" href="adminDanhSachChuyenDi.php?phuongtien=2">Tàu hoả</a></li>
            <li><a class="dropdown-item" href="adminDanhSachChuyenDi.php?phuongtien=3">Xe khách</a></li>
        </ul>
    </div><br>
