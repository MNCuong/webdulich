...
<body>
	<?php
		...
		if ($file_error === UPLOAD_ERR_OK) {
			...
			$sql_insert_dulich="INSERT INTO `tourdulich` 
			(`id`, `diadiem`, `tinhthanh`, `theloai`, `giatien`, `anh`, `dacdiem`, `gioithieu`) 
			VALUES('$id','$diadiem', '$tinhthanh', '$theloai', '$giatien', '$file__name__', '$dacdiem', '$gioithieu')";
